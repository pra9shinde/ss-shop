 ...
 <div class="app-content content" style="background:white; width: 100%; height:100%;">
  <div class="content-wrapper" id="invoice-template">
    ...
    <div class="content-body" id="invoice-template">
        <section class="card">
            <a href="http://localhost:8080/ss-shop/Shop/testDomPDF" target="_blank" class="btn btn-outline-info mb-1" style="margin-right:0.2rem;margin-left:-2px;"><i class="la la-print"></i> Print Invoice </a>
            ...
            <div  class="card-body">
                ...
                <div style="width:100%" class="clearfix">
                        ...
                        <tr>
                            ...
                            <td>
                                <ul class="ml-2 px-0 list-unstyled left-ul">
                                    ...
                                    <li>Mobile No : +91-111111,</li>
                                    <li>Pincode : 121212 </li>
                                </ul>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table style="width:50%; float:right;">
                        ...
                        <tr>
                            <td><p class="pb-sm-3 text-right"># INV-0000001</p></td>
                ...
                <div style="width:100%" class="clearfix">
                    <div style="width:50%; float:left">
                        <ul class="px-0 list-unstyled">
                                <li class="text-bold-800">Mr/Mrs. Shinde</li>
                                <li>Americ,</li>
                                <li>Pin : 123123,</li>
                                <li>+91 - 1111111111.</li>
                        </ul>
                    ...
                    <div style="width:50%; float:right">
                        ...
                        <p class="text-right"><span class="text-muted">Invoice Date :</span>10 Jun 2019</p>
                        ...
                        <div class="table-responsive col-12">
                            <table class="table">
                                ...
                                <tbody>
                                      ...
                                      <tr class="group"><td colspan="9"><h6 class="mb-0">Category - <span class="text-bold-600">Food</span></h6></td></tr>
                                          ...
                                          <tr>
                                              ...
                                              <td>
                                                  <p>Parle G</p>
                                                  <p class="text-muted">Best Biscuit
                                                  </p>
                                              </td>
                                    ...
                                    <table class="tb-total" style="width: 100%; margin-bottom: 1rem; color: #6b6f82;">
                                        <tbody>
                                            ...
                                            <tr class="group" style="color:#a73737;">
                                                ...
                                                <td class="text-bold-800 text-right"><b>₹10000</b></td>
                                            </tr>
                                        </tbody>
                                    </table>
