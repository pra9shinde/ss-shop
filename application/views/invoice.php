                            ...
                            <div class="col-sm-6 col-12 text-center text-sm-left">
                                <div class="media row">
                                    <div class="col-12 col-sm-4 col-xl-4">
                                        <img src="<?= base_url() ?>assets/login/K2C LOGO.jpg" alt="Smart Society Services" class="mb-1 mb-sm-0" width="100%" />
                                    </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($item['items'] as $order_item) : ?>
                                                ...
                                                <tr class="group">
                                                    <td colspan="10">
                                                        <h6 class="mb-0">Category - <span class="text-bold-600"><?= $order_item[0]['category_name'] ?></span></h6>
                                                    </td>
                                                </tr>
