                ...
                <div class="form-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 mx-auto">
                            ...
                            <input type="hidden" class="form-control" name="products_array" id="products_array">
                            <textarea rows="6" class="form-control " name="reason" id="reason"></textarea>
                        </div>
                    </div>
                </div>
                <div class="footer-btns">
                    <button type="button" class="btn btn-outline-danger" onclick="ChangeOrderStatus()">Save changes</button>
